    ...
    <>
      ...
      <div className="flex min-h-screen">
        <motion.aside
          ...
          className="fixed left-0 top-0 z-20 hidden h-screen flex-col md:flex"
          style={{
            ...
            <div className="flex items-center gap-3 bg-[#003087] p-2 shadow-sm">
              ...
              {!isCollapsed && (
                <motion.div
                  ...
                  className="flex flex-1 flex-col"
                >
                  <span className="text-lg font-medium text-[#FF6B35]">{fullName}</span>
                  <span className="break-all text-xs text-white">{email}</span>
                </motion.div>
              )}
            </div>
            <Button
          ...
          {isMobileMenuOpen && (
            <>
              ...
              <motion.aside
                ...
                className="fixed left-0 top-0 z-40 flex h-screen w-80 flex-col md:hidden bg-white"
              >
                <div className="flex h-14 items-center justify-between border-r-2 border-r-[#FF6B35] bg-[#003087] px-3">
                  ...
                  <Button
                    ...
                    size="icon"
                    onClick={() => setIsMobileMenuOpen(false)}
                    className="text-white hover:bg-[#002060]"
                  >
                    <X className="h-5 w-5" />
                  </Button>
                </div>
        ...
        {/* Main Content */}
        <main className={cn("flex-1 transition-all", "md:pl-[240px]")}>
          <div className="sticky top-0 z-10 h-14 border-b bg-[#003087]">
            <div className="flex h-full items-center gap-4 px-4 md:px-6">
              <Button
                ...
                className="md:hidden text-white hover:bg-[#002060]"
              >
              ...
              <Button
                ...
                size="icon"
                onClick={() => setIsCollapsed(!isCollapsed)}
                className="hidden md:flex text-white hover:bg-[#002060]"
              >
