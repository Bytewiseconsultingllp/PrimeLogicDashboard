      ...
      try {
        ...
        switch (currentStepIndex) {
              ...
              if (checkResult.success && checkResult.data) {
                ...
                if (isClient) {
                  ...
                  if (typeof window !== 'undefined') {
                    ...
                    toast.error('Email already registered as client! Please use a different email.', {
                      duration: 6000,
                      style: {
                        background: "#EF4444",
                        color: "white",
                  ...
                  if (typeof window !== 'undefined') {
                    const toast = (await import('react-hot-toast')).default
                    toast.success('Registration successful! Welcome to Prime Logic Solutions.', {
                      duration: 4000,
                      style: {
                        background: "#10B981",
                        color: "white",
          ...
          case 5: // Step 6: Special Offers/Discount
            if (!visitorId) throw new Error('Visitor ID not found')
            const discountTypeMap: any = {
              "startup": "STARTUP_FOUNDER",
              "veteran": "VETERAN_OWNED_BUSINESS",
              "nonprofit": "NONPROFIT_ORGANIZATION",
              "none": "NOT_ELIGIBLE"
            }
            const discountType = discountTypeMap[formData.specialOffers.discounts[0]?.type] || "NOT_ELIGIBLE"
            await api.addVisitorDiscount(visitorId, {
              type: discountType,
              percent: formData.specialOffers.appliedDiscount || 0,
              notes: formData.specialOffers.discounts[0]?.notes
            })
          ...
          case 8: // Step 9: Service Agreement
            // This will be handled in the agreement component
            break
