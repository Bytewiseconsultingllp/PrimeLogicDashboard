...
export function DocumentUpload({ 
  ...
  const handleFileChange = async (e: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      setIsUploading(true)
      const response = await fetch(`${process.env.NEXT_PUBLIC_PLS}/projects/${projectId}/client-brief/upload`, {
        method: 'POST',
        headers: {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_PLS}/projects/${projectId}/client-brief`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('accessToken')}`,
        },
      })
